...
import { onCreateNodeTemplate } from '@/app/(main)/(pages)/workflows/_actions/workflow-connection'
...
const ActionButton = ({
  ...
  const onStoreNotionContent = useCallback(async () => {
    // Extract content properly - it might be an object with name property
    let content: string = nodeConnection.notionNode.content as any
    if (typeof content === 'object' && content !== null) {
      content = (content as any).name || JSON.stringify(content)
